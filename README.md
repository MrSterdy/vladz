...
-   Удобный просмотр и изменение расписаний _(Начало занятий, предметы и их преподаватели, кабинеты, домашние задания)_ _(**ВАЖНО!!!** Изменённые расписания автоматически очищаются спутся 7 дней позле внесения изменений)_
